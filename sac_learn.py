...
def worker(id, sac_trainer, rewards_queue, replay_buffer, max_episodes, max_steps, batch_size, explore_steps,
    ...
    for eps in range(max_episodes):
        ...
        for step in range(max_steps):
            ...
            try:
                ...
                frame_itr_lst.append(frame_idx)
    ...
    print('Frame Iteration List', np.array(frame_itr_lst).shape)
    print('Step List', step_lst)
    print('Episode List', epiode_lst)
    print('Done List', done_lst)
    print('Reward List', reward_lst)
    # name=['Frame Iteration List','Step List','Episode List','Done List','Reward List','X Error List','X Mean Error List','Y Error List', 'Z Error List', 'Sqrt Distance List']
    data_dict={'Frame Iteration List':frame_itr_lst,'Step List':step_lst,'Episode List':epiode_lst,'Done List':done_lst,'Reward List':reward_lst,'X Error List':env.x_error_lst,'X Mean Error List':env.x_mean_error_lst, 'Y Error List':env.y_error_lst, 'Z Error List':env.z_error_lst, 'Sqrt Distance List':env.sqrt_distance_lst}
    df=pd.DataFrame(data_dict)
    print(df) 
    reward_dict={'Episode Reward',episode_reward}
    reward_df = pd.DataFrame(reward_dict)
    df.to_csv('/home/luanzhang/Hiwi_Ye_20210918/iiwa_14_RL_Path_Tracking-main/iiwa_rl/results/step_episode_reward_error.csv',encoding='utf-8',mode='w')
    reward_df.to_csv('/home/luanzhang/Hiwi_Ye_20210918/iiwa_14_RL_Path_Tracking-main/iiwa_rl/results/episode_reward.csv',encoding='gbk')
